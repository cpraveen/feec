...
Compare with Fig. 5.1 of Arnold. Left figure shows mixed formulation and right shows the primal formulation. The primal formulation converges to wrong solution.
